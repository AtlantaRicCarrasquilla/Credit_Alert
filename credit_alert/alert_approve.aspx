<%@ Page Language="C#" AutoEventWireup="true" CodeFile="alert_approve.aspx.cs" Inherits="alert_approve" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            ...
            <asp:Panel runat="server" ID="pnlConfirm" CssClass="pnlConfirmPrint"><strong>
                <asp:Label runat="server" ID="lblConfirmString" /></strong></asp:Panel>
            ...
            <asp:Panel runat="server" ID="pnlInfo" CssClass="pnlInfo">
                <table>
                    ...
                    <tr>
                        ...
                        <td>
                            <asp:Label runat="server" ID="lblOrdNum" Text="[OrdNum]" /></td>
                    </tr>
                    <tr>
                        <td align="right">Date Posted:</td>
                        <td>
                            <asp:Label runat="server" ID="lblDatePosted" Text="[Date Posted]" /></td>
                    </tr>
                    <tr>
                        <td align="right">Company Name:</td>
                        <td>
                            <asp:Label runat="server" ID="lblCompName" Text="[Company Name]" /></td>
                    </tr>
                    <tr>
                        <td align="right">Account Code:</td>
                        <td>
                            <asp:Label runat="server" ID="lblAcctCode" Text="[Account Code]" /></td>
                    </tr>
                    <tr>
                        <td colspan="2">
                            <hr />
                    ...
                    <tr>
                        <td align="right" valign="top">
                            <asp:Label runat="server" ID="lblOtherAlerts" Text="Required Approvals" /></td>
                        <td>
                            <table class="table_OtherAlerts">
                                <tr>
                                    <td class="table_OtherAlerts_c1">
                                        <asp:Label runat="server" ID="lblOther_C" Text="Credit Alert - " /></td>
                                    <td>
                                        <asp:Label runat="server" ID="lblOtherCredit" /></td>
                                </tr>
                                <tr>
                                    <td class="table_OtherAlerts_c1">
                                        <asp:Label runat="server" ID="lblOther_T" Text="Tech Alert - " /></td>
                                    <td>
                                        <asp:Label runat="server" ID="lblOtherTech" /></td>
                                </tr>
                                <tr>
                                    <td class="table_OtherAlerts_c1">
                                        <asp:Label runat="server" ID="lblOther_R" Text="RIS Alert - " /></td>
                                    <td>
                                        <asp:Label runat="server" ID="lblOtherRIS" /></td>
                                </tr>
                            </table>
